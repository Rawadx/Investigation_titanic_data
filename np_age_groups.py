...
ylabel_pas = 'Number of Passengers'
ylabel_surv = 'Number of Survivors'
ylabel_rate = 'Percentage of Total'

def plot_bar(xval, yval, data, title, ylabel):
    ax1 = plt.subplot(111)
...
plot_bar(xval, total_yval, age_groups, total_title, ylabel_pas)
plot_bar(xval, surv_yval,age_groups, surv_title,ylabel_surv)
plot_bar(xval, rate_yval,age_groups, rate_title, ylabel_rate)
