...
plot_bar(xval, total_yval, pass_class, total_title, ylabel_pas)
plot_bar(xval, surv_yval, pass_class, surv_title, ylabel_surv)
plot_bar(xval, rate_yval, pass_class, rate_title, ylabel_rate)
